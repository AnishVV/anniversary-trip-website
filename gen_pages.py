...
pages = [
    dict(
        ...
        details='\n'.join([
            ...
            det("Where", "119 3rd Ave S<br>Nashville, TN 37201"),
    ...
    dict(
        ...
        blurb="Y'all are about to become line dancers — and trust us, you'll want these moves for Station Inn tonight. Turn Their Heads has been hyped as one of the best line dancing experiences in Nashville. No experience required. Just show up ready to stomp, laugh, and look good doing it.",
        details='\n'.join([
    ...
    dict(
        ...
        location="401 11th Ave S · The Gulch, Nashville",
        ...
        details='\n'.join([
            ...
            det("Style", "Mediterranean small plates — order generously, share everything"),
            det("Note", "Station Inn is right around the corner — easy walk after dinner"),
        ]),
        map_src=osm(36.1497, -86.7876),
        map_query="Zaytinya+401+11th+Ave+S+Nashville+TN",
    ),
    dict(
        file="concert.html",
        ...
        subtitle="The World's Greatest Bluegrass Club · Est. 1974",
        location="402 12th Ave S · The Gulch, Nashville",
        blurb="This is not a tourist trap. The Station Inn is genuinely world-famous — one of the greatest live music venues on the planet, and Nashville's undisputed home of bluegrass since 1974. Wooden chairs, cold beer, no frills, and music that will stop you cold. You don't leave the same.",
        details='\n'.join([
            det("When", "Saturday, June 6 · 8:00 PM"),
            det("Where", "402 12th Ave S<br>Nashville, TN 37203"),
            det("Tickets", "Pay at the door — cash welcomed · typically $15–20/person"),
            det("Vibe", "Intimate, no-frills, completely authentic — wooden chairs &amp; cold beer"),
            det("Pro Tip", "Arrive 15–20 min early for a good seat. Shows go late — leave whenever feels right."),
            det("After", "Walk back through The Gulch — dessert spots between here and the hotel"),
        ]),
    ...
    dict(
        ...
        blurb="Trade the Nashville skyline for Tennessee stars. Short Mountain Holiday is a stunning countryside escape — a proper cabin stay in Liberty, TN with Amber &amp; Micah as your hosts. After a full weekend in the city, this is the perfect way to finish the trip in quiet, beautiful peace.",
        details='\n'.join([
            ...
            det("Note", "Check-in instructions will be sent after final payment. About 1 hour drive from Nashville."),
        ]),
