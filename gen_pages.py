...
pages = [
    ...
    dict(
        ...
        title="Sunday Brunch — Biscuit Love",
        cover_eyebrow="Sunday Morning · Nashville",
        cover_title="One last slow morning in Nashville...",
        eyebrow="Brunch  ·  Sunday",
        script_line="One last slow morning at",
        big_name="Biscuit Love",
        subtitle="Southern Brunch · The Gulch",
        location="316 11th Ave S · The Gulch, Nashville",
        blurb="The last Nashville morning calls for the best biscuits in town. Biscuit Love is famous for their Bonuts — fried biscuit-dough topped with lemon mascarpone &amp; blueberry compote. Order the most indulgent thing on the menu. You've earned it.",
        details='\n'.join([
            det("When", "Sunday, June 7 · 11:00 AM"),
            det("Where", "316 11th Ave S (The Gulch)<br>Nashville, TN 37203"),
            det("Order", "Bonuts — fried biscuit-dough with lemon mascarpone &amp; blueberry compote"),
            det("Good to Know", "No reservations — first come, first served. Open 7 AM–3 PM Sunday."),
            det("Backup", "Milk &amp; Honey is right around the corner at 214 11th Ave S if the wait is long."),
        ]),
        map_src=osm(36.1519, -86.7881),
        map_query="Biscuit+Love+316+11th+Ave+S+Nashville+TN",
    ),
    dict(
        file="lodging.html",
    ...
    dict(
        file="sunday-checkout.html",
        title="Sunday Checkout — Caption by Hyatt",
        cover_eyebrow="Sunday Morning · Nashville",
        cover_title="Time to check out and hit the road...",
        eyebrow="Checkout  ·  Sunday Morning",
        script_line="Wrapping up the weekend at",
        big_name="Caption by Hyatt",
        subtitle="Checkout · The Gulch",
        location="118 12th Ave S · The Gulch, Nashville",
        blurb="Time to check out and start the adventure east. Ask the front desk to hold your bags while you head to brunch — you'll swing back to grab them before picking up the rental car.",
        details='\n'.join([
            det("When", "Sunday, June 7 · 10:45 AM"),
            det("Where", "118 12th Ave S (The Gulch)<br>Nashville, TN 37203"),
            det("Bags", "Ask the front desk to hold your luggage after checkout — pick it up on the way to the rental car."),
            det("After This", "Head straight to Biscuit Love for brunch (316 11th Ave S, 5-min walk)"),
        ]),
        map_src=osm(36.1521, -86.7889),
        map_query="Caption+by+Hyatt+118+12th+Ave+S+Nashville+TN",
    ),
    dict(
        file="sunday-rental-car.html",
        title="Sunday — Rental Car Pickup",
        cover_eyebrow="Sunday Afternoon · Nashville",
        cover_title="Your chariot awaits...",
        eyebrow="Rental Car  ·  Sunday Afternoon",
        script_line="Hitting the road from",
        big_name="Rental Car",
        subtitle="Nashville Downtown",
        location="532 6th Ave S · Nashville, TN 37203",
        blurb="This is your ride for the rest of the trip — pick it up and you're officially on the open road. The location closes at 1:00 PM, so aim to arrive by 12:30.",
        details='\n'.join([
            det("When", "Sunday, June 7 · 12:30 PM"),
            det("Where", "532 6th Ave S<br>Nashville, TN 37203"),
            det("Booking #", "9735036771"),
            det("Heads Up", "Location closes at 1:00 PM sharp — arrive by 12:30 PM."),
            det("Return", "Monday, June 8 · 4:00 PM"),
        ]),
        map_src=osm(36.1556, -86.7745),
        map_query="532+6th+Ave+S+Nashville+TN+37203",
    ),
    dict(
        file="sunday-coffee.html",
        title="Sunday — Coffee Stop",
        cover_eyebrow="Sunday Afternoon · Nashville",
        cover_title="One for the road...",
        eyebrow="Coffee  ·  Sunday Afternoon",
        script_line="A quick stop for coffee —",
        big_name="Coffee Stop",
        subtitle="Sunday · 1:15 PM",
        location="Nashville, Tennessee",
        blurb="Fuel up before the drive east. Three great options — pick whichever sounds right for the mood.",
        details='\n'.join([
            det("When", "Sunday, June 7 · 1:15 PM"),
            det("Option A", "<strong>Americano Lounge</strong><br>434 Houston St Ste 120 (Wedgewood-Houston)<br>Moody jazz lounge with velvet furnishings &amp; a fireplace inside Houston Station. Order the Satchmo Latte.<br><em style='font-size:.8em;opacity:.7'>Open until 5:00 PM</em>"),
            det("Option B", "<strong>Osa Coffee Roasters</strong><br>1579 Edgehill Ave (Edgehill/Music Row)<br>Walk-up bar with on-site roasting, Japanese-minimal vibe — a true locals' spot. Order the honey latte.<br><em style='font-size:.8em;opacity:.7'>Open until 4:00 PM</em>"),
            det("Option C", "<strong>Crema Coffee Roasters</strong><br>15 Hermitage Ave (SoBro — closest to rental car)<br>Nashville's flagship specialty roaster since 2008. Industrial-warm space with skyline patio views. Order the Cuban coffee.<br><em style='font-size:.8em;opacity:.7'>Open until 4:00 PM</em>"),
        ]),
        map_src=osm(36.15685, -86.76972),
        map_query="Crema+Coffee+Roasters+15+Hermitage+Ave+Nashville+TN",
    ),
    dict(
        file="sunday-grocery.html",
        title="Sunday — Walmart Pickup",
        cover_eyebrow="Sunday Afternoon · Mt. Juliet",
        cover_title="Swinging by for the order...",
        eyebrow="Grocery Pickup  ·  Sunday Afternoon",
        script_line="Quick stop at",
        big_name="Walmart",
        subtitle="Curbside Pickup · Mt. Juliet, TN",
        location="300 Pleasant Grove Rd Ste 600 · Mt. Juliet, TN 37122",
        blurb="Order is already placed — just pull up to the curbside pickup lane and they'll load everything into the car. Quick stop before heading east to the dome.",
        details='\n'.join([
            det("When", "Sunday, June 7 · 1:45 PM"),
            det("Where", "300 Pleasant Grove Rd Ste 600<br>Mt. Juliet, TN 37122"),
            det("Type", "Curbside pickup — order is pre-placed, no need to go inside"),
            det("Phone", "(615) 758-1121"),
        ]),
        map_src=osm(36.196, -86.519),
        map_query="Walmart+Supercenter+300+Pleasant+Grove+Rd+Mt+Juliet+TN+37122",
    ),
    dict(
        file="sunday-wine.html",
        title="Sunday — Providence Wine & Spirits (Optional)",
        cover_eyebrow="Optional Stop · Mt. Juliet",
        cover_title="If you want it, it's right here...",
        eyebrow="Optional Stop  ·  Sunday",
        script_line="A quick detour to",
        big_name="Providence Wine",
        subtitle="&amp; Spirits · Mt. Juliet, TN",
        location="1986 Providence W Pkwy · Mt. Juliet, TN 37122",
        blurb="If THC seltzers are on the list — this is the spot. Mt. Juliet's largest wine and spirits shop, right in the Providence corridor, just a couple minutes from Walmart.",
        details='\n'.join([
            det("When", "Sunday, June 7 · 2:00 PM (optional)"),
            det("Where", "1986 Providence W Pkwy<br>Mt. Juliet, TN 37122"),
            det("Sunday Hours", "11:00 AM – 7:00 PM"),
            det("Phone", "(615) 288-2407"),
            det("Looking For", "THC seltzers"),
        ]),
        map_src=osm(36.1641, -86.5161),
        map_query="Providence+Wine+and+Spirits+1986+Providence+W+Pkwy+Mt+Juliet+TN",
    ),
    dict(
        file="sunday-lebanon-square.html",
        title="Sunday — Lebanon Square (Optional)",
        cover_eyebrow="Optional Stop · Lebanon, TN",
        cover_title="A little detour worth taking...",
        eyebrow="Optional Stop  ·  Sunday",
        script_line="Stretch your legs at",
        big_name="Lebanon Square",
        subtitle="Historic Public Square · Lebanon, TN",
        location="Public Square · Lebanon, TN 37087",
        blurb="A 10-acre National Register of Historic Places district formed in 1802. Wander the 19th-century brick storefronts, browse the eclectic shops, and soak up small-town Tennessee charm before the final push to the dome.",
        details='\n'.join([
            det("When", "Sunday, June 7 · 2:30 PM (optional)"),
            det("Where", "Public Square, Lebanon, TN 37087"),
            det("New Era Vintage", "Best overall browse — vintage clothing, 80s/90s nostalgia, VHS, video games, toys &amp; CDs. Open Sun 12–5 PM."),
            det("Jack's Guitarcheology", "Specializes in weirdo &amp; specialty vintage guitars — a fast, oddball music-history browse even if you don't buy anything. Open Sun 12–5 PM."),
            det("Action Nerd Fun Spot", "Comics, toys, records, games, trading cards, collectibles &amp; pinball. Open Sun 11–4 PM."),
            det("Urban Mills Boutique", "Small accessories and apparel right on the square. Open Sun 12–4 PM."),
        ]),
        map_src=osm(36.2081, -86.2911),
        map_query="Public+Square+Lebanon+TN+37087",
    ),
    dict(
        file="sunday-dinner.html",
        title="Sunday Dinner — Kountry Thai",
        cover_eyebrow="Sunday Evening · Woodbury, TN",
        cover_title="Ending the trip on something special...",
        eyebrow="Dinner  ·  Sunday Evening",
        script_line="An unexpected gem —",
        big_name="Kountry Thai",
        subtitle="Thai Restaurant · Woodbury, TN",
        location="804 McMinnville Hwy · Woodbury, TN 37190",
        blurb="A beloved local gem in Woodbury — surprisingly authentic Thai food in small-town Tennessee. Bold flavours, fresh ingredients, and spice levels up to 5. About 30 minutes from the dome.",
        details='\n'.join([
            det("When", "Sunday, June 7 · 7:00 PM"),
            det("Where", "804 McMinnville Hwy<br>Woodbury, TN 37190"),
            det("Phone", "(615) 563-4050"),
            det("Sunday Hours", "11:30 AM – 8:00 PM"),
            det("Order", "Tom Kha coconut soup · Chicken Pad Thai · Massaman Curry"),
            det("Spice Level", "1 (mild) to 5 (native Thai heat) — order what you can handle"),
            det("Heads Up", "Leave Short Mountain by 6:30 PM — it's about 30 minutes away"),
        ]),
        map_src=osm(35.824, -86.076),
        map_query="Kountry+Thai+Restaurant+804+McMinnville+Hwy+Woodbury+TN",
    ),
    dict(
        file="monday-rental-car.html",
        title="Monday — Return Rental Car",
        cover_eyebrow="Monday Afternoon · Nashville",
        cover_title="Almost home — one last stop...",
        eyebrow="Rental Car Return  ·  Monday Afternoon",
        script_line="Dropping the keys back at",
        big_name="Rental Return",
        subtitle="Nashville Downtown · 4:00 PM",
        location="532 6th Ave S · Nashville, TN 37203",
        blurb="Same spot you picked it up — drop the keys and you're done. Call your Uber from the lot immediately after so you have plenty of time for bag drop and security.",
        details='\n'.join([
            det("When", "Monday, June 8 · 4:00 PM"),
            det("Where", "532 6th Ave S<br>Nashville, TN 37203"),
            det("Booking #", "9735036771"),
            det("Next Step", "Call Uber immediately — aim to depart by 4:15 PM for the airport"),
        ]),
        map_src=osm(36.1556, -86.7745),
        map_query="532+6th+Ave+S+Nashville+TN+37203",
    ),
    dict(
        file="monday-uber.html",
        title="Monday — Uber to BNA",
        cover_eyebrow="Monday Afternoon · Nashville",
        cover_title="Heading to the airport...",
        eyebrow="Ride to Airport  ·  Monday Afternoon",
        script_line="Rideshare to",
        big_name="Nashville BNA",
        subtitle="Nashville International Airport",
        location="One Terminal Dr · Nashville, TN 37214",
        blurb="BNA is about 15–20 minutes from downtown. Delta recommends arriving 2 hours before departure — leaving at 4:15 PM gives you a comfortable ~2.5 hour buffer before the 6:50 PM flight.",
        details='\n'.join([
            det("Depart", "Monday, June 8 · 4:15 PM from 532 6th Ave S"),
            det("Destination", "Nashville International Airport (BNA)<br>One Terminal Dr, Nashville, TN 37214"),
            det("Drive Time", "~15–20 minutes from downtown"),
            det("Check-In", "Delta check-in counters + bag drop in the main terminal"),
            det("Heads Up", "Download boarding passes to your phone before arriving"),
        ]),
        map_src=osm(36.1245, -86.6782),
        map_query="Nashville+International+Airport+BNA",
    ),
    dict(
        file="monday-flight.html",
        title="Monday — Flight Home",
        cover_eyebrow="Monday Evening · Nashville BNA",
        cover_title="That's a wrap — wheels up...",
        eyebrow="Flight Home  ·  Monday Evening",
        script_line="Taking off on",
        big_name="Delta 3945",
        subtitle="Nashville → Austin",
        location="Nashville BNA · Gate TBD",
        blurb="That's a wrap on the trip. Nashville to Austin — the weekend lives on in your memory (and your camera roll). Safe travels.",
        details='\n'.join([
            det("Flight", "Delta Air Lines 3945"),
            det("Departs", "Nashville BNA · 6:50 PM (local)"),
            det("Arrives", "Austin AUS · 9:16 PM (local)"),
            det("Confirmation", "GFDSZJ"),
            det("Heads Up", "Check in online and download boarding passes before you arrive at the airport"),
        ]),
        map_src=osm(36.1245, -86.6782),
        map_query="Nashville+International+Airport+BNA",
    ),
